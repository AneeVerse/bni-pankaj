        ...
        <div className="max-w-[1230px] mx-auto h-22 md:h-18 flex items-center">
          ...
          <div className="flex items-center ml-auto">
            ...
            <div className="flex-shrink-0 ml-4 sm:ml-6 md:ml-8">
              <Link
                href="/contact"
                className="bg-[#3470cc] hidden sm:block text-white font-medium py-2 px-3 sm:py-2.5 sm:px-4 md:py-2 md:px-5 rounded-full hover:bg-white hover:text-black transition-colors text-xs sm:text-sm md:text-base"
              >
                CONTACT
              </Link>
            </div>
