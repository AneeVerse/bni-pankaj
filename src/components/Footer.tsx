...
export default function Footer() {
  return (
    <footer className="w-full bg-black text-white py-12 md:py-16 lg:py-20">
      <div className="container mx-auto px-4 max-w-[1400px]">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8 mb-12">
          ...
          <div className="space-y-4 md:col-span-2 lg:col-span-1">
            <div>
              <a href="#" className="text-white hover:text-gray-300 transition-colors font-medium flex items-center">
                Customer Support
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center space-y-4 md:space-y-0">
            ...
            <div className="flex items-center justify-between w-full md:w-auto">
              ...
              <a 
                ...
                className="flex items-center space-x-3 text-sm text-gray-400 hover:text-gray-300 transition-colors group"
              >
