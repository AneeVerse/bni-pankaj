      ...
      <section className="w-full bg-white">
        <div className="container mx-auto px-4 sm:px-6 md:px-0 max-w-[1400px] py-4 sm:py-6 md:py-8 lg:py-10">
           ...
           <div className="relative grid grid-cols-1 md:grid-cols-5 gap-0 overflow-hidden rounded-2xl sm:rounded-3xl">
             ...
             <div
               className="absolute inset-0 w-200 h-100 left-68 top-20 -translate-x-1/2 -translate-y-1/2  z-15 mx-auto my-auto bg-cover bg-center bg-no-repeat hidden md:block"
               style={{
            ...
            <div className="relative bg-[#efefef] rounded-tr-3xl rounded-bl-3xl rounded-tl-3xl rounded-br-3xl md:col-span-3 z-25">
            ...
            <div className="relative bg-[#efefef] rounded-tr-3xl rounded-bl-3xl rounded-tl-3xl md:col-span-2 z-25">
              <div className="p-6 md:p-8 lg:p-10 flex flex-col justify-center min-h-[250px] relative z-30">
            ...
            <div className="relative bg-[#efefef] rounded-tl-2xl sm:rounded-tl-3xl  rounded-br-3xl md:col-span-3 overflow-hidden z-10">
              {videoUrl ? (
      ...
      <section className="w-full bg-white">
        <div className="container mx-auto px-4 md:px-0 max-w-[1400px] py-6 md:py-8 lg:py-10">
          ...
          <div className="relative grid grid-cols-1 md:grid-cols-5 gap-0  overflow-hidden  rounded-3xl">
            ...
            {/* Section 2 - Expert Guidance Text (Top Right) - Curved on Bottom Left - 3/5 width */}
            <div className="relative bg-[#efefef] rounded-tr-3xl rounded-bl-3xl rounded-br-3xl rounded-tl-3xl md:col-span-3 z-25">
              <div className="p-6 md:p-8 lg:p-10 flex flex-col justify-center min-h-[250px] relative z-30">
                <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-6 md:mb-8">
                  Expert guidance for your path
                </h2>
            ...
            {/* Section 4 - Video (Bottom Right) - Curved on Top Left - 3/5 width (big video section) */}
            <div className="relative bg-[#efefef] rounded-tl-3xl rounded-br-3xl rounded-tr-3xl md:col-span-3 overflow-hidden z-10">
              {videoUrl ? (
                <div className="relative w-full h-full min-h-[250px] flex items-center justify-center z-30">
                  {/* Video Container with Unified Gradient Integration */}
                  <div
