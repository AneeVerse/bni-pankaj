  ...
  const closeVideoPopup = () => {
    ...
    if (popupVideoRef.current) {
      ...
      <section className="w-full bg-white py-12 md:py-16 lg:py-20">
        ...
        <div className="relative grid grid-cols-1 md:grid-cols-5 gap-0 shadow-2xl overflow-hidden bg-gradient-to-br from-[#245cd9] via-[#245cd9]/100 to-[#245cd9]/100 rounded-3xl">
          ...
          <div className="relative bg-white rounded-tl-3xl rounded-br-3xl overflow-hidden md:col-span-3 z-10">
            <Image
          ...
          <div className="relative bg-white rounded-tr-3xl rounded-bl-3xl md:col-span-2 z-25">
            <div className="p-6 md:p-8 lg:p-10 flex flex-col justify-center min-h-[400px] relative z-30">
          ...
          <div className="relative bg-white rounded-tl-3xl md:col-span-2 overflow-hidden z-10">
              ...
              <div className="relative w-full h-full min-h-[200px] md:min-h-[250px] flex items-center justify-center z-30">
                ...
                <div 
                  className="relative w-3/5 h-4/5 rounded-3xl overflow-hidden mr-60 -top-8"
                  style={{
                    borderRadius: '1.5rem',
