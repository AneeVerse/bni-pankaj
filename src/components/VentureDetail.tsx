    ...
    <>
      ...
      <div className="container mx-auto px-4 md:px-0 max-w-[1400px]">
        ...
        <div className="relative grid grid-cols-1 md:grid-cols-5 gap-0  overflow-hidden  rounded-3xl">
          ...
          <div className="absolute inset-0 w-1/3 h-1/3 left-100 -top-10 -translate-x-1/2 -translate-y-1/2 bg-gradient-to-br from-[#245cd9] via-[#245cd9]/100 to-[#245cd9]/90 rounded-full z-15 mx-auto my-auto"></div>

                                           {/* Section 1 - BNI Logo (Top Left) - Curved on Top Right and Bottom Left - 2/5 width (small box) */}
            <div className="relative bg-[#efefef] rounded-tr-3xl rounded-bl-3xl overflow-hidden md:col-span-2 z-10">
             ...
             <div className="p-6 md:p-8 lg:p-10 flex flex-col justify-center min-h-[250px] relative z-30">
                ...
                <div className="flex justify-between mb-8">
                  <div className="text-left">
                    <div className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-2">81%</div>
                    <div className="text-gray-900 text-lg md:text-xl">improved time management</div>
                  </div>
                  
                  <div className="text-left">
                    <div className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-2">70%</div>
                    <div className="text-gray-900 text-lg md:text-xl">increased work performance</div>
                  </div>
                </div>

               <p className="text-gray-900 text-base md:text-lg lg:text-xl leading-relaxed mb-8 font-medium">
               ...
               <div className="flex flex-col gap-4">
                 <button className="bg-gray-900 hover:bg-gray-800 text-white px-6 md:px-8 py-3 md:py-4 rounded-4xl font-semibold text-sm md:text-base transition-colors w-full">
                   Results coaching
                 </button>
                 <button className="bg-gray-900 hover:bg-gray-800 text-white px-6 md:px-8 py-3 md:py-4 rounded-4xl font-semibold text-sm md:text-base transition-colors w-full">
                   Business coaching
          ...
          <div className="relative bg-white rounded-tl-3xl md:col-span-3 overflow-hidden z-10">
            {videoUrl ? (
              <div className="relative w-full h-full min-h-[250px] flex items-center justify-center z-30">
                ...
                <div 
                  className="relative w-11/12 h-11/12 rounded-3xl overflow-hidden -mt-10 -ml-18"
                  style={{
                    borderRadius: '1.5rem',
      ...
      <div className="container mx-auto px-4 md:px-0 max-w-[1400px]">
        ...
        <div className="relative grid grid-cols-1 md:grid-cols-5 gap-0  overflow-hidden  rounded-3xl">
          ...
          <div className="absolute inset-0 w-1/3 h-1/3 left-100 -top-10 -translate-x-1/2 -translate-y-1/2 bg-gradient-to-br from-[#245cd9] via-[#245cd9]/100 to-[#245cd9]/90 rounded-full z-15 mx-auto my-auto"></div>
               ...
               <div className="relative bg-white rounded-tr-3xl rounded-br-3xl md:col-span-3 z-25">
                <div className="p-6 md:p-8 lg:p-10 flex flex-col justify-center min-h-[250px] relative z-30">
                 <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-6 md:mb-8 ml-12">
                   Expert guidance for your path
                 </h2>
               </div>
             </div>
             ...
             <div className="relative bg-[#efefef] rounded-tl-3xl rounded-br-3xl overflow-hidden md:col-span-2 z-10">
               <div className="p-6 md:p-8 lg:p-10 flex items-center justify-center min-h-[250px] relative z-30">
                <Image
            ...
            <div className="relative bg-white rounded-tr-3xl rounded-bl-3xl md:col-span-3 overflow-hidden z-10">
              {videoUrl ? (
                <div className="relative w-full h-full min-h-[250px] flex items-center justify-center z-30">
                  {/* Video Container with Unified Gradient Integration */}
                  <div 
                    className="relative w-11/12 h-11/12 rounded-3xl overflow-hidden -mt-10 ml-20"
                   style={{
                     borderRadius: '1.5rem',
                     WebkitBorderRadius: '1.5rem',
                     MozBorderRadius: '1.5rem'
           ...
           {/* Section 4 - Statistics and Coaching Info (Bottom Right) - Curved on Top Left - 2/5 width */}
            <div className="relative bg-white rounded-tl-3xl rounded-br-3xl md:col-span-2 z-25">
              <div className="p-6 md:p-8 lg:p-10 flex flex-col justify-center min-h-[250px] relative z-30">
                                {/* Statistics - Side by side */}
                 <div className="flex justify-between mb-8">
                   <div className="text-left">
